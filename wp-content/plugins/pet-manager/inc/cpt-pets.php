...
function create_pet_status_taxonomy()
{
    ...
    $labels = array('name' => _x( 'Status','wp_pet'),'menu_name' => __( 'Status','wp_pet'), __( 'Add pet status','wp_pet'));
		register_taxonomy( 'pet-status', 'pet', array( 'hierarchical' => false, 'labels' => $labels, 'query_var' => 'pet-status', 'public' =>FALSE, 'show_ui'=>TRUE, 'show_admin_column'=>TRUE,'show_in_nav_menus'=>TRUE,'rewrite' => array( 'slug' => __('status','wp_pet'), 'hierarchical' => false,'with_front' => FALSE ) ) );
    flush_rewrite_rules();
}
...
function create_pet_genre_taxonomy()
{
    ...
    $labels = array('name' => _x( 'Gender','wp_pet'),'menu_name' => __( 'Genders','wp_pet'), 'add_new_item' => __( 'Add pet gender','wp_pet'));
		register_taxonomy( 'pet-gender', 'pet', array( 'hierarchical' => false, 'labels' => $labels, 'query_var' => 'pet-gender', 'public' =>FALSE, 'show_ui'=>TRUE, 'show_admin_column'=>TRUE,'show_in_nav_menus'=>TRUE, 'rewrite' => array( 'slug' => __('genre','wp_pet'), 'hierarchical' => false,'with_front' => FALSE ) ) );
    flush_rewrite_rules();
}
...
function create_pet_size_taxonomy()
{
    ...
    $labels = array('name' => _x( 'Size','wp_pet'),'menu_name' => __( 'Sizes','wp_pet'), 'add_new_item' => __( 'Add pet size','wp_pet'));
		register_taxonomy( 'pet-size', 'pet', array( 'hierarchical' => false, 'labels' => $labels, 'query_var' => 'pet-size', 'public' =>FALSE, 'show_ui'=>TRUE, 'show_in_nav_menus'=>TRUE, 'rewrite' => array( 'slug' => __('size','wp_pet'), 'hierarchical' => false,'with_front' => FALSE ) ) );
    flush_rewrite_rules();
}
...
function create_pet_age_taxonomy()
{
    ...
    $labels = array('name' => _x( 'Age','wp_pet'),'menu_name' => __( 'Ages','wp_pet'), 'add_new_item' => __( 'Add pet age','wp_pet'));
		register_taxonomy( 'pet-age', 'pet', array( 'hierarchical' => false, 'labels' => $labels, 'query_var' => 'pet-age', 'public' =>FALSE, 'show_ui'=>TRUE, 'show_in_nav_menus'=>TRUE, 'rewrite' => array( 'slug' => __('age','wp_pet'), 'hierarchical' => false,'with_front' => FALSE ) ) );
    flush_rewrite_rules();
}
...
function create_pet_breed_taxonomy()
{
    ...
    $labels = array('name' => _x( 'Breeds','wp_pet'),'menu_name' => __( 'Breeds','wp_pet'), 'add_new_item' => __( 'Add pet breed','wp_pet'));
		register_taxonomy( 'pet-breed', 'pet', array( 'hierarchical' => false, 'labels' => $labels, 'query_var' => 'pet-breed', 'public' =>FALSE, 'show_ui'=>TRUE, 'show_in_nav_menus'=>TRUE,'rewrite' => array( 'slug' => __('breed','wp_pet'), 'hierarchical' => false,'with_front' => FALSE ) ) );
    flush_rewrite_rules();
}
...
function create_pet_coat_taxonomy()
{
    ...
    $labels = array('name' => _x( 'Coat','wp_pet'),'menu_name' => __( 'Coats','wp_pet'), 'add_new_item' => __( 'Add pet coat','wp_pet'));
		register_taxonomy( 'pet-coat', 'pet', array( 'hierarchical' => false, 'labels' => $labels, 'query_var' => 'pet-coat','public' =>FALSE, 'show_ui'=>TRUE, 'show_in_nav_menus'=>TRUE, 'rewrite' => array( 'slug' => __('coat','wp_pet'), 'hierarchical' => false,'with_front' => FALSE ) ) );
    flush_rewrite_rules();
}
...
function create_pet_pattern_taxonomy()
{
    ...
    $labels = array('name' => _x( 'Pattern','wp_pet'),'menu_name' => __( 'Patterns','wp_pet'), __( 'Add pet pattern','wp_pet'));
		register_taxonomy( 'pet-pattern', 'pet', array( 'hierarchical' => false, 'labels' => $labels, 'query_var' => 'pet-pattern', 'public' =>FALSE, 'show_ui'=>TRUE, 'show_in_nav_menus'=>TRUE,'rewrite' => array( 'slug' => __('pattern','wp_pet'), 'hierarchical' => false,'with_front' => FALSE ) ) );
    flush_rewrite_rules();
}
...
function create_pet_color_taxonomy()
{
    ...
    $labels = array('name' => _x( 'Color','wp_pet'),'menu_name' => __( 'Colors','wp_pet'), __( 'Add pet color','wp_pet'));
		register_taxonomy( 'pet-color', 'pet', array( 'hierarchical' => false, 'labels' => $labels, 'query_var' => 'pet-color', 'public' =>FALSE, 'show_ui'=>TRUE, 'show_in_nav_menus'=>TRUE, 'rewrite' => array( 'slug' => __('color','wp_pet'), 'hierarchical' => false,'with_front' => FALSE ) ) );
    flush_rewrite_rules();
}
